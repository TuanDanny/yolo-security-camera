...
// =================================================================================
// ===                  HÀM startCameraServer ĐÃ ĐƯỢC SỬA LẠI                     ===
// =================================================================================

void startCameraServer() {
  httpd_config_t config = HTTPD_DEFAULT_CONFIG();
  config.max_uri_handlers = 16; // Tăng số lượng handler để chứa tất cả

  // Định nghĩa tất cả các URI (đường dẫn) mà server sẽ xử lý
  ...
  log_i("Bat dau Web Server tren cong: '%d'", config.server_port);
  
  // Khởi động MỘT server duy nhất và đăng ký TẤT CẢ các URI vào nó
  if (httpd_start(&camera_httpd, &config) == ESP_OK) {
    ...
    // === ĐĂNG KÝ URI STREAM VÀO SERVER CHÍNH ===
...
// Hàm này không liên quan đến web server, giữ nguyên
void setupLedFlash() {
#if defined(LED_GPIO_NUM)
